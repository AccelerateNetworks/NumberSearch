...
namespace NumberSearch.Ops.Controllers
{
    public class AspNetRolesController : Controller
    {
        ...
        public AspNetRolesController(numberSearchContext context)
        {
            _context = context;
        }
        ...
        [Authorize]
        [HttpGet("AspNetRoles/Details/{id}")]
        ...
        [Authorize]
        [HttpPost("AspNetRoles/Delete/{id}")]
        [ValidateAntiForgeryToken]
