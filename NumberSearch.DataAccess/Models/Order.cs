...
namespace NumberSearch.DataAccess
{
    public record Order
    {
        ...
        public bool VoiceProductAcknowledged { get; set; }
        public DateTime? VoiceProductAcknowledgedUtc { get; set; } = null;
        /// <summary>
        /// The contract term in years for fiber internet on this order, or 0 when the order has no fiber internet.
        /// </summary>
        public int InternetTermYears { get; set; }
        /// <summary>
        /// The listed service address the fiber internet on this order was qualified at, from the provider's building list.
        /// </summary>
        public string InternetServiceAddress { get; set; } = string.Empty;
        /// <summary>
        /// The provider's key for that building, which stays the same when a new building list is imported.
        /// </summary>
        ...
        public static async Task<Order?> GetByIdAsync(Guid orderId, string connectionString)
        {
            ...
            var result = await connection
                .QueryFirstOrDefaultAsync<Order>("SELECT \"OrderId\", \"FirstName\", \"LastName\", \"Email\", \"Address\", \"Address2\", \"City\", \"State\", \"Zip\", \"DateSubmitted\", \"BusinessName\", \"CustomerNotes\", \"BillingClientId\", \"BillingInvoiceId\", \"Quote\", \"BillingInvoiceReoccuringId\", \"SalesEmail\", \"BackgroundWorkCompleted\", \"Completed\", \"InstallDate\", \"UpfrontInvoiceLink\", \"ReoccuringInvoiceLink\", \"OnsiteInstallation\", \"AddressUnitType\", \"AddressUnitNumber\", \"UnparsedAddress\", \"MergedOrderId\", \"E911ServiceNumber\", \"DateConvertedFromQuote\", \"DateCompleted\", \"ContactPhoneNumber\", \"DateUpfrontInvoicePaid\", \"InternalNotes\", \"QuoteStatus\", \"VoiceProductAcknowledged\", \"VoiceProductAcknowledgedUtc\", \"InternetTermYears\", \"InternetServiceAddress\", \"InternetBuildingKey\" FROM public.\"Orders\" " +
        ...
        public static async Task<IEnumerable<Order>> GetAllAsync(string connectionString)
        {
            ...
            var result = await connection
                .QueryAsync<Order>
                ("SELECT \"OrderId\", \"FirstName\", \"LastName\", \"Email\", \"Address\", \"Address2\", \"City\", \"State\", \"Zip\", \"DateSubmitted\", \"BusinessName\", \"CustomerNotes\", \"BillingClientId\", \"BillingInvoiceId\", \"Quote\", \"BillingInvoiceReoccuringId\", \"SalesEmail\", \"BackgroundWorkCompleted\", \"Completed\", \"InstallDate\", \"UpfrontInvoiceLink\", \"ReoccuringInvoiceLink\", \"OnsiteInstallation\", \"AddressUnitType\", \"AddressUnitNumber\", \"UnparsedAddress\", \"MergedOrderId\", \"E911ServiceNumber\", \"DateConvertedFromQuote\", \"DateCompleted\", \"ContactPhoneNumber\", \"DateUpfrontInvoicePaid\", \"InternalNotes\", \"QuoteStatus\", \"VoiceProductAcknowledged\", \"VoiceProductAcknowledgedUtc\", \"InternetTermYears\", \"InternetServiceAddress\", \"InternetBuildingKey\" " +
                "FROM public.\"Orders\" " +
                "ORDER BY \"DateSubmitted\" DESC")
                .ConfigureAwait(false);
